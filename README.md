...
- `init_db.py`: Database initialization script to set up the Postgresql database and seed questions.
...
## Data Flow
1. **Database → Backend**: 
   - When the quiz starts, the backend (`app.py`) queries the Postgresql database.
